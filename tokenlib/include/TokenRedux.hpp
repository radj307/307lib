...
namespace token {
	namespace base {
		...
		#pragma endregion GetNext
			 ...
			 * @param bracketOpen	The lexeme type associated with opening brackets, used to detect scope. This must be different than the closing bracket!
			 * @param bracketClose	The lexeme type associated with closing brackets, used to detect scope & the ending delimiter. This must be different than the opening bracket!
			...
			/**
			 * @protected
			 * @brief				Retrieve all of the characters from the current read pos until the first unescaped lexeme.
			 * @param delim			The delimiter lexeme to stop at.
			 * @param no_rollback	When true, the character matched by the predicate will be eaten.
			 * @returns				std::string
			 */
